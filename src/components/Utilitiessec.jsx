...
const Utilitiessec = () => {
        return (
                <div className='bg-blk py-5 '>
                        <Container>
                                <h2 className='text-white fs-lg1 m-0 pb-5  fw-normal text-center ff-azo'>Utilities</h2>
                                <Row className='pb-5 '>
                                        <Col lg={4} className='d-flex justify-content-center'>
                                                <div className='crd-boxes  p-3 mt-4 position-relative overflow-hidden'>
                                                        <div className='light-Moon'></div>
                                                        <div className='light-Moon-2'></div>
                                                        <div className='d-flex justify-content-center'>
                                                                <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none">
                                                        ...
                                                        <h2 className='text-center fs-md1 fw-semibold m-0  mt-3 crds-h ff-montserrat'>Document</h2>
                                                        <p className=' fs-sm fw-normal text-center m-0 pt-3 mx-330 mx-auto ff-montserrat  crds-p'>Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus. </p>
                                                </div>
                                        </Col>
                                        <Col lg={4} className='d-flex justify-content-center'>
                                                <div className='crd-boxes p-3 mt-4 position-relative overflow-hidden'>
                                                        ...
                                                        <h2 className='text-center fs-md1 fw-semibold m-0 ff-montserrat mt-3 crds-h'>Deal</h2>
                                                        <p className='fs-sm fw-normal text-center m-0 pt-3 ff-montserrat mx-330 mx-auto  crds-p'>Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus. </p>
                                                </div>
                                        </Col>
                                        <Col lg={4} className='d-flex justify-content-center'>
                                                <div className='crd-boxes p-3 mt-4 position-relative overflow-hidden'>
                                                        ...
                                                        <div className='light-Moon-2'></div>
                                                        <div className='d-flex justify-content-center '>
                                                                <a href="#"><svg className='contract' width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <h2 className='text-center fs-md1 fw-semibold m-0 ff-montserrat mt-3 crds-h'>Contract</h2>
                                                        <p className='fs-sm fw-normal text-center m-0 pt-3 ff-montserrat mx-330 mx-auto  crds-p'>Turpis et tortor vel pharetra nibh. Mauris nisl sit vitae viverra amet et. Erat nam molestie. Vitae mollis lacus senectus mattis nisl. Porta , adipiscing sed mus diam amet, ac sed tellus. </p>
                                                </div>
                                        </Col>
                                </Row>
